...
if __name__ == '__main__':
    ...
    parser.add_argument('--seq_len', type=int, default=32, help='sequence length of input') #tester sur des séquences plus longues pour le foot ?
    parser.add_argument('--epochs', type=int, default=3, help='number of epochs') #plus ?
    ...
    parser.add_argument('--bg_mode', type=str, default='', choices=['', 'subtract', 'subtract_concat', 'concat'], help='background mode') #voir les subtitlités
    ...
    parser.add_argument('--tolerance', type=float, default=8, help='difference tolerance of center distance between prediction and ground truth in input size')
    parser.add_argument('--resume_training', action='store_true', default=False, help='resume training from experiment directory') #true pour finetune ?
